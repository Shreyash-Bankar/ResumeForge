  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
        ...
        <a
          href="https://drive.google.com/drive/folders/1AZ6DrRVP-Zava5cUPv8C8VD0SJTaw5Tp?usp=sharing"
          target="_blank"
    ...
    <div className="relative group">
      ...
      <div className="text-center mt-4">
        ...
        <p className="text-lg mb-4" style={{ color: 'var(--color-foreground-secondary)' }}>
          A Project By{' '}
          <a
            href="https://www.linkedin.com/in/shreyash-bankar-28b304262/"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="flex justify-center items-center gap-6"> {/* Increased gap for larger icons */}
          ...
          <a
            href="https://github.com/Shreyash-Bankar"
            target="_blank"
            rel="noopener noreferrer"
